...
export const Hero = () => {
  ...
  <section ref={heroRef} className="pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip">
    <div className="container">
      ...
      <div className="inline-flex text-lg px=4 py-1.5 rounded-xl border border-black/50">
                      <motion.span
                      animate={{
        ...
        <p className="text-xl text-[#010D3E] tracking-tight mt-6">
          Celebrate the joy of your accomplishments with an app designed to track
          your progress, movitave your efforts, and celebrate your successes.
          </p>
          <div className="flex gap-1 items-center mt-[30px] md:flex-1">
      ...
      <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
        ...
        />
        <motion.img src={noodle.src} alt="Noodle Image" width={220} height={220}
